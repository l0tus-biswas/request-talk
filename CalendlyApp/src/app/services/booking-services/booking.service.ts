...
export class BookingService {
  ...
  publicgetUserData(userName: string): Observable<IUsers[]> {
    return this.http.get<IUsers[]>("https://localhost:44305/api/Calendly/PublicgetUserData?userName=" + userName ).pipe(catchError(this.errorHandler));
  }

  publicgetAvaibilityData(userId: number, availId: number): Observable<IAvailibility[]> {
    return this.http.get<IAvailibility[]>("https://localhost:44305/api/Calendly/PublicgetAvaibilityData?userId=" + userId + "&avaibilityId=" + availId).pipe(catchError(this.errorHandler));
  }

  publicgetEventData(userId: number, url: string): Observable<IEvents[]> {
    return this.http.get<IEvents[]>("https://localhost:44305/api/Calendly/PublicgetEventData?userId=" + userId + "&url=" + url).pipe(catchError(this.errorHandler));
  }

  getAllBookings(userName: string): Observable<IBooking[]> {
    return this.http.get<IBooking[]>("https://localhost:44305/api/Calendly/GetAllBooking?userName=" + userName ).pipe(catchError(this.errorHandler));
  }
  ...
  addNewBooking(username: string, eventId: number, eventName: string,  bookedTime:string,  appointmentUsername :string,  appointmentUserPhoneNumber:string,  appointmentUserEmail:string,  appointmentGuestEmail:string,  additionalNotes:string,sendConfirmationMail: string, bookingstatus: string): Observable<boolean> {
    return this.http.post<boolean>("https://localhost:44305/api/Calendly/AddNewBooking", {
      bookedUser: username,
  ...
  updateConfirmationOnMailSentEvent( bookedUser: string, bookingId:number): Observable<boolean>  {
    ...
    return this.http.put<boolean>("https://localhost:44305/api/Calendly/ConfirmationMailMeeting", {
  ...
  updateBookingOnConfirm( bookedUser: string, bookingId:number): Observable<boolean>  {
    ...
    return this.http.put<boolean>("https://localhost:44305/api/Calendly/BookingOnConfirm", {
      bookedUser: bookedUser,
      bookingId: bookingId
    }).pipe(catchError(this.errorHandler));
}
...
updateBookingOnReject( bookedUser: string, bookingId:number): Observable<boolean>  {
  ...
  return this.http.put<boolean>("https://localhost:44305/api/Calendly/BookingOnReject", {
    bookedUser: bookedUser,
    bookingId: bookingId
  }).pipe(catchError(this.errorHandler));
}
updateBookingOnReschedule( bookedUser: string, bookingId:number): Observable<boolean>  {
  ...
  return this.http.put<boolean>("https://localhost:44305/api/Calendly/BookingOnReschedule", {
    bookedUser: bookedUser,
    bookingId: bookingId
  }).pipe(catchError(this.errorHandler));
}
updateBookingOnComplete( bookedUser: string, bookingId:number): Observable<boolean>  {
  ...
  return this.http.put<boolean>("https://localhost:44305/api/Calendly/BookingOnComplete", {
    bookedUser: bookedUser,
    bookingId: bookingId
  }).pipe(catchError(this.errorHandler));
}
...
updateBookingOnCancel( bookedUser: string, bookingId:number): Observable<boolean>  {
  ...
  return this.http.put<boolean>("https://localhost:44305/api/Calendly/BookingOnCancel", {
    bookedUser: bookedUser,
    bookingId: bookingId
  }).pipe(catchError(this.errorHandler));
}
